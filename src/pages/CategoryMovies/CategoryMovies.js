  ...
  useEffect(() => {
    ...
    switch (categoryName) {
      case "TrendingMovies": {
        ...
        fetch(
          `https://api.themoviedb.org/3/trending/movie/day?language=en-US&page=${pageNum}`,
          options
        )
      ...
      case "TrendingTv": {
        fetch(
          `https://api.themoviedb.org/3/trending/tv/day?language=en-US&page=${pageNum}`,
          options
        )
          .then((response) => response.json())
          .then((response) => {
      ...
      case "AiringToday": {
        fetch(
          `https://api.themoviedb.org/3/tv/airing_today?language=en-US&page=${pageNum}`,
          options
        )
          .then((response) => response.json())
          .then((response) => {
